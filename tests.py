...
def test_parsing_livecoin():
    ...
    some_expected_symbols = ['crypto.BTC/USD-last', 'crypto.BTC/USD-low', 'crypto.ETH/USD-last']
...
def test_parsing_iex():
    ...
    metric_names = [m['name'] for m in metrics]
    some_expected_symbols = ['stocks.WORK-latestPrice', 'stocks.NFLX-latestPrice', 'stocks.AMZN-latestPrice']
